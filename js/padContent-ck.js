 ...
 */var consts={patinaTransparencyTop:105,patinaTransparencyBottom:472,bottomMaskTop:482},padContentF=function(e){$("#contentText").css("padding-top",consts.patinaTransparencyTop+"px");$("#contentText").css("padding-bottom",$(window).height()-consts.patinaTransparencyBottom+"px");$("#footer").css("height",$(window).height()-consts.bottomMaskTop+"px")};$(window).load(padContentF);$(window).resize(padContentF);